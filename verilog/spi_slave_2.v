 ...
 *
 * Inputs:
 *    i_Rst_L - Reset signal
 *    i_Clk - Main clock signal
 *    i_TX_DV - Data Valid pulse to register i_TX_Byte
 *    i_TX_Byte - Byte to serialize to MISO
 *    i_SPI_Clk - Communication clock signal
 *    i_SPI_MOSI - Master out slave in signal
 *    i_SPI_CS_n - Chip select signal
 *
 * Outputs:
 *    o_RX_DV - Data Valid pulse (1 clock cycle)
 *    o_RX_Byte - Byte received on MOSI
 *    o_SPI_MISO - Master in slave out signal
 *
 * Functionality:
 ...
 *    Sending bits still has a synchronization issue
 */
